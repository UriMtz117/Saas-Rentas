...
export default function RootLayout({
  ...
  // Cargar los datos de sesión y vigilar la actividad
  useEffect(() => {
      ...
      <body className="bg-[#f8fafc] text-slate-900 flex min-h-screen overflow-hidden font-sans antialiased italic-none">
        ...
        <header className="lg:hidden fixed top-0 left-0 w-full bg-slate-900 text-white p-4 flex justify-between items-center z-[60] shadow-xl">
          <div className="flex items-center gap-2">
            ...
            <span className="font-black tracking-tighter uppercase italic text-sm text-blue-400">
              InmoGestion
            </span>
          </div>
          ...
          <button
            type="button"
            onClick={() => setIsMenuOpen((estado) => !estado)}
        ...
        >
          <div className="p-8 mb-4 flex items-center gap-3">
            ...
            <div>
              <span className="text-xl font-black tracking-tighter block leading-none uppercase italic">
                InmoGestion
              </span>

              <span className="text-[9px] font-black text-blue-400 tracking-[0.3em] uppercase">
                Intelligence AI
              </span>
            </div>
          </div>
          ...
          <nav className="flex-1 px-4 space-y-1 overflow-y-auto custom-scrollbar">
            <p className="text-[9px] font-black text-slate-500 uppercase tracking-[0.3em] ml-4 mb-4 italic">
              Navegación
            </p>
            ...
            {role === "ADMIN" && (
              <div className="pt-6 mt-6 border-t border-slate-800">
                <p className="text-[9px] font-black text-blue-500 uppercase tracking-[0.3em] ml-4 mb-4 italic">
                  Administrador
                </p>
          ...
          <div className="p-6 border-t border-slate-800 bg-slate-900/50 flex items-center justify-between">
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="flex flex-col min-w-0 text-left">
                <p className="text-sm font-bold text-slate-100 truncate tracking-tighter uppercase italic">
                  {userName}
                </p>
            ...
            <button
              ...
              className="text-slate-500 hover:text-red-500 transition-all active:scale-90"
        ...
        <main className="flex-1 flex flex-col h-screen overflow-hidden relative">
          ...
          <header className="w-full p-4 lg:p-6 justify-end items-center gap-4 bg-transparent z-40 no-print hidden lg:flex">
            {/*
              Notificaciones usa useSearchParams().
              Debe estar dentro de Suspense para que
              Next.js pueda completar el build.
            */}
